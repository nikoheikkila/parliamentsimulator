...
class PairingsControllerTest < ActionController::TestCase
  ...
  test "should create pairing" do
    assert_difference('Pairing.count') do
      post :create, pairing: { party_id: @pairing.party_id, position: @pairing.position, value_id: @pairing.value_id }
    end
  ...
  test "should update pairing" do
    patch :update, id: @pairing, pairing: { party_id: @pairing.party_id, position: @pairing.position, value_id: @pairing.value_id }
    assert_redirected_to pairing_path(assigns(:pairing))
  end
